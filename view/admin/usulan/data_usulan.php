                    ...
                    <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    ...
                                    <a class="nav-link" href="data_usulan.php">Issue</a>
                                </nav>
                            </div>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                <table id="datatablesSimple">
                                    ...
                                    <?php 
                                        $no=0;
                                        $query=mysqli_query($koneksi, " SELECT * FROM usul");
                                    ...
                                    ?>  
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" class="btn btn-danger float-end mx-2" data-bs-toggle="modal" data-bs-target="#modal-hapus<?php echo $row['id_usul'] ?>">
                                                Hapus
                                                </button>
                                            </td>
                                        </tr>
                                        <!-- sesi star hapus usul -->
                                        <div class="modal fade" id="modal-hapus<?php echo $row['id_usul'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                         <form action="hapus_usul.php" method="POST">
                                                            <div class="mb-3">
                                                                <label class="form-label">Anda yakin ingin hapus</label>
                                                                <input type="hidden" class="form-control" id="exampleInputPassword1" name="id_usul" value="<?php echo $row['id_usul']?>">
                                                                <input type="text" class="form-control" id="exampleInputPassword1" name="tentang" value="<?php echo $row['nama']?>" readonly>
                                                            </div>
                                                            <div class="mb-3">
