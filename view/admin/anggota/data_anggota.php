                                                            ...
                                                            <div class="modal-body">
                                                                <form action="hapus_data.php" method="POST">
                                                                    <div class="mb-3">
                                                                        ...
                                                                        <input type="text" class="form-control" id="exampleInputPassword1" name="email" value="<?php echo $row['email']?>" readonly>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                    <button type="submit" class="btn btn-primary">Submit</button>
                                                                    </div>
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="edit_data.php" method="POST">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Nama</label>
                                                                        <input type="hidden" class="form-control" id="exampleInputPassword1" name="id" value="<?php echo $row['id']?>">
                                                                        <input type="text" class="form-control" id="exampleInputPassword1" name="nama" value="<?php echo $row['nama']?>">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Email address</label>
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Jenis Kelamin</label>
                                                                        <input type="text" class="form-control" id="exampleInputPassword1" name="jenis_kelamin" value="<?php echo $row['jenis_kelamin']?>">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="form-label">jabatan</label>
                                                                        <input type="text" class="form-control" id="exampleInputPassword1" name="jabatan" value="<?php echo $row['jabatan']?>">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                    <button type="submit" class="btn btn-primary">Submit</button>
                                                                    <button type="button" class="btn btn-secondary mx-2" data-bs-dismiss="modal">Close</button>
