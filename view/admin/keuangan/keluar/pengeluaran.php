        ...
        <div id="layoutSidenav">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    ...
                    <div class="nav">
                            ...
                            <div class="sb-sidenav-menu-heading">Keuangan</div>
                                <a class="nav-link" href="../masuk/pemasukan.php">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                        <h1 class="mt-4">Pengluaran Kas </h1> 
                        <div class="card mb-4">
                                        ...
                                        <?php 
                                            ...
                                            while($row=mysqli_fetch_assoc($query)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <!-- tombol edit -->
                                                    <button type="button" class="btn btn-warning float-end" data-bs-toggle="modal" data-bs-target="#modal-edit<?php echo $row['id_pengeluaran'] ?>">
                                                    Edit
                                                    </button>
                                                        <!-- akhir Tombol edit -->

                                                        <!-- tombol hapus -->
                                                    <button type="button" class="btn btn-danger float-end mx-2" data-bs-toggle="modal" data-bs-target="#modal-hapus<?php echo $row['id_pengeluaran'] ?>">
                                                    Hapus
                                                    </button>
                                                        <!-- akhir tombol hapus -->
                                                    </td>
                                                ...
                                                <!-- Awal Sesi Hapus -->
                                                <div class="modal fade" id="modal-hapus<?php echo $row['id_pengeluaran'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="delet_keluar.php" method="POST">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Anda yakin ingin hapus</label>
                                                                        <input type="hidden" class="form-control" id="exampleInputPassword1" name="id_pengeluaran" value="<?php echo $row['id_pengeluaran']?>">
                                                ...
                                                <!-- Akhir sesi Hapus -->
                                                <!-- Awal sesi edit -->
                                                <div class="modal fade" id="modal-edit<?php echo $row['id_pengeluaran'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="edit_keluar.php" method="POST">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Tanggal</label>
                                                                        <input type="hidden" class="form-control" id="exampleInputPassword1" name="id_pengeluaran" value="<?php echo $row['id_pengeluaran']?>">
                                                                    ...
                                                                    <div class="mb-3">
                                                                        <label class="form-label">jumlah</label>
                                                                        <input type="num" class="form-control" id="exampleInputPassword1" name="jumlah" value="<?php echo "Rp ". number_format($row['jumlah'], 0, '.','.')?>">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                    <button type="submit" class="btn btn-primary">Submit</button>
                                                                    <button type="button" class="btn btn-secondary mx-2" data-bs-dismiss="modal">Close</button>
