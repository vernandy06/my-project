        ...
        <div id="layoutSidenav">
                ...
                <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
                    ...
                    <div class="nav">
                            ...
                            <div class="sb-sidenav-menu-heading">Keuangan</div>
                                ...
                                <a class="nav-link" href="../keluar/pengeluaran.php">
            ...
            <div id="layoutSidenav_content">
                ...
                <div class="container-fluid px-4">
                        <h1 class="mt-4">Pemasukan Kas </h1> 
                        <div class="card mb-4">
                            <div class="card-header text-dark bg-light">
                                <i class="fas fa-table me-1"></i>
                                Pemasukan Kas Organisasi
                                    ...
                                    <tbody>
                                        <?php 
                                            ...
                                            while($row=mysqli_fetch_assoc($query)){
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="">
                                                        ...
                                                        <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                                             <!-- tombol edit -->
                                                    <button type="button" class="btn btn-warning me-md-2" data-bs-toggle="modal" data-bs-target="#modal-edit<?php echo $row['id_pemasukan'] ?>">
                                                    Edit
                                                    </button>
                                                        <!-- akhir Tombol edit -->

                                                        <!-- tombol hapus -->
                                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modal-hapus<?php echo $row['id_pemasukan'] ?>">
                                                    Hapus
                                                    </button>
                                                        <!-- akhir tombol hapus -->
                                                        </div>
                                                ...
                                                <!-- Awal Sesi Hapus -->
                                                <div class="modal fade" id="modal-hapus<?php echo $row['id_pemasukan'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="delet_masuk.php" method="POST">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Anda yakin ingin hapus</label>
                                                                        <input type="hidden" class="form-control" id="exampleInputPassword1" name="id_pemasukan" value="<?php echo $row['id_pemasukan']?>">
                                                                        <input type="text" class="form-control" id="exampleInputPassword1" name="keterangan" value="<?php echo $row['keterangan']?>" readonly>
                                                                    </div>
                                                                    <div class="mb-3">
                                                                    <button type="submit" class="btn btn-primary">Submit</button>
                                                                    </div>
                                                ...
                                                <!-- Akhir sesi Hapus -->
                                                <!-- Awal sesi edit -->
                                                <div class="modal fade" id="modal-edit<?php echo $row['id_pemasukan'] ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                            ...
                                                            <div class="modal-body">
                                                                <form action="edit_masuk.php" method="POST">
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Tanggal</label>
                                                                        <input type="hidden" class="form-control" id="exampleInputPassword1" name="id_pemasukan" value="<?php echo $row['id_pemasukan']?>">
                                                                        <input type="date" class="form-control" id="exampleInputPassword1" name="tanggal" value="<?php echo date('Y-m-d'); ?>">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Keterangan</label>
                                                                        <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="keterangan" value="<?php echo $row['keterangan']?>">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                        <label class="form-label">Jumlah</label>
                                                                        <input type="num" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="jumlah" value="<?php echo "Rp ". number_format($row['jumlah'], 0, '.','.')?>">
                                                                    </div>
                                                                    <div class="mb-3">
                                                                    <button type="submit" class="btn btn-primary">Submit</button>
                                                                    <button type="button" class="btn btn-secondary mx-2" data-bs-dismiss="modal">Close</button>
